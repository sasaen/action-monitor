...
Run it by opening a terminal, cd to the downloaded folder and type:  mvn spring-boot:run
 ...
 Notes: 
  ...
  - As for the rest endpoints, I was not sure what the goal was here so I made 2 assumptions. Let me know if they don't meet the expectations:
	...
	- As for the status endpoint, I thought it was a good idea to reuse Spring HATEOAS Actuator endpoint which provide links to other end points: health, metrics, beans, etc: 
 ...
 TODO:
  - Make sure the application works with different browsers and from different machines, Linux/Android. I will complete this over the week.
